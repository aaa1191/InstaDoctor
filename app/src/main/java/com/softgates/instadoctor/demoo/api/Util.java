...
public class Util {
    ...
    public static ApiInterface zoomApi()
    {
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                ...
                .build();
        Retrofit retrofit = new Retrofit.Builder().baseUrl("https://unclefluffy.com/instadoctor/test/assets/api/").client(okHttpClient).addConverterFactory(GsonConverterFactory.create()).build();
