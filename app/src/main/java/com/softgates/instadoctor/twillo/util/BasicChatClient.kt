package com.softgates.instadoctor.twillo.util
import ToastStatusListener
import android.content.Context
import android.os.AsyncTask
import android.os.Handler
import android.util.Log
import com.softgates.instadoctor.twillo.TwilioApplication
...

{
    ...
    init {
        if (BuildConfig.DEBUG) {
          //  warn { "Enabling DEBUG logging" }
            Log.e("BasicChatClient","Enabling DEBUG logging")
    ...
    override fun onSuccess(client: ChatClient) {
     //   debug { "Received completely initialized ChatClient" }
        Log.e("BasicChatClient","Received completely initialized ChatClient")
    ...
    private fun getAccessToken() {
        Log.e("TWILLOGITHUB","GETACCESS TOKEN....."+urlString);
