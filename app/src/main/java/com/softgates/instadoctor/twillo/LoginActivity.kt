...
import com.softgates.instadoctor.BuildConfig
import com.softgates.instadoctor.R
import com.softgates.instadoctor.twillo.util.BasicChatClient
import kotlinx.android.synthetic.main.activity_login.*


class LoginActivity : Activity(), BasicChatClient.LoginListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        login.setOnClickListener {
         ...
         //   debug { "url string : $url" }
            Log.e("LoginActivity","url string : $url")
...
//
        if (checkPlayServices()) {
         ...
         //mk   startService<RegistrationIntentService>()
        }
    }
    ...
    private fun showAboutDialog() {
       /* alert("Version: ${ChatClient.getSdkVersion()}", "About") {
        ...
        Log.e("LoginActivity","Dialog is open is called")
    ...
    override fun onLoginStarted() {
     //   debug { "Log in started" }
        Log.e("LoginActivity","Log in started")
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (apiAvailability.isUserResolvableError(resultCode)) {
               ...
               // info { "This device is not supported." }
                Log.e("LoginActivity","This device is not supported.")
